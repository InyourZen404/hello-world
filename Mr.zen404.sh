...
#Gak Usah Compas :"v 
#GW BIKIN CAPE ANJING
#Tholol Gak Usah NYAMPE KETULANG
#YOU KNOW ME
...
echo -b "AUTHOR    : Mr.Zen404 $green " |lolcat
...
echo -b "NOTES     : Jangan Disalah Gunakan _/\_ " | lolcat
echo -b "_____________________________________________________________" | lolcat
...
echo -e "######################################" | lolcat
echo -e "#SILAHKAN TUNNGU JANGAN SAMBIL COLLI:V#" | lolcat
echo -e "######################################" | lolcat
...
00) echo "AUTHOR: Mr.Zen404" | lolcat
echo "YOU KNOW ME? MR.ZEN" | lolcat
